...
export default function ContactsPage() {
  ...
  const fetchContacts = async () => {
    try {
      const response = await axios.get('https://api.myvrloan.com/api/contacts', {
        headers: {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`https://api.myvrloan.com/api/contacts/${id}`, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem('token')}`
        }
      });
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-gray-500 truncate">Read Messages</dt>
                  <dd className="text-lg font-semibold text-gray-900">
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-semibold text-gray-900">{contacts.length}</dd>
                </dl>
              </div>
            </div>
          </div>
